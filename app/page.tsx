	...
	const eventsData: {
		...
		"@Kuriovation": (
			...
			<div className="space-y-4">
				...
				<div className="eventcontent">
					...
					<h2 className="text information" id="mode">
						Theme: Innovation for Persons with Disabilities
					</h2>
				</div>
				<ol className="list-disc">
					<li className="item" id="point">
						Students will have to submit their ideas for prelims. The idea must
						make use of robotics/IOT/AI for developing prompt appropriate gadgets.
					</li>

					<li className="item" id="point">
						They must submit a ppt/pdf containing the synopsis of their
					...
					<li className="item" id="point">
						A total of 20 teams will be selected for the final round which will
						be held offline in the school premises.
					</li>

					<li className="item" id="point">
						Participants have to present their project/idea and are required to make a poster as well as 
		...
		"@MechaMarvel": (
			<div className="space-y-4">
				...
				<a href="/events/mecha.pdf" className="shade" target="_blank">
		...
		"@Synapse": (
			<div className="space-y-4">
			<video src="./eventstitle/synapse.mp4" autoPlay muted className="h-[8rem] mt-[-2rem] w-[102rem]" loop></video>
		...
		"@RoboRush": (
			<div>
				...
				<a href="/events/robo.pdf" className="shade" target="_blank">
					<b>Click To Know More</b>
				</a>
			</div>
		),
		"@AquaDash": (
			<div>
				...
				<ol className="list-disc">
					<li className="item" id="point">
						<b>
							The first 10 teams to register will be allowed to participate.
						</b>
					</li>
				...
				<a href="/events/aquadash.pdf" className="shade" target="_blank">
					<b>Click To Know More</b>
				</a>
			</div>
		),
...
<video src="./eventstitle/cypher.mp4" autoPlay muted className="h-[8rem] mt-[-2rem] w-[102rem]" loop></video>
			...
			<h2 className="text information" id="lang"><b>Prelims</b></h2>
				...
				<ol className="list-disc">
					...
					<a href="/events/cyber.pdf" className="shade"target="_blank">
					<b>Click To Know More</b>
				</a>
			</div>
		),
		...
		<video src="./eventstitle/techtales.mp4" autoPlay muted className="h-[8rem] mt-[-2rem] w-[102rem]" loop></video>
				...
				<a href="/events/tech.pdf" className="shade" target="_blank">
					<b>Click To Know More</b>
				</a>
			</div>
		),
	...
	return (
		<body className="dark">
			...
			<main
				id="home"
				className="max-[600px]:h-[45rem] dark h-screen grid grid-rows-3 place-items-center overflow-hidden bg-[conic-gradient(var(--tw-gradient-stops))] from-[#0084B0] to-[#000608]"
			>
				<FloatingNav navItems={navItems} showPopup={showPopup}className="max-[600px]:hidden mt-[-1rem]"/>
				<div
					className={
						"max-[600px]:ml-[3rem] tracking-[0.4vw] text-[30px] self-end" + helvetica.className
					}
				>
			...
			<div className="guidelinesGradient">
				...
				>
					...
					>
						...
						<p className="max-[600px]:text-xs md:text-2xl text-xl font-medium text-center text-white relative z-20 max-w-2xl mx-auto mb-20">
					...
					>
						...
						<p className="max-[600px]:text-sm md:text-2xl text-xl font-medium text-center text-white relative z-20 max-w-2xl mx-auto">
				...
				<main
					id="guidelines"
					className="max-[600px]:h-[160rem] dark h-screen flex flex-col items-center overflow-hidden justify-evenly "
				>
					<div
						className={
							"max-[600px]:text-[3rem] guidelines text-[15vh] leading-none z-0 h-1/6 " +
														montserrat.className
						}
					>
						GUIDELINES
					</div>
					<div className="max-[600px]:flex-col max-[600px]:ml-[10rem] w-4/5 max-w-5xl flex gap-[7rem] mt-[2rem] ">
				...
				<main id="trailer"
					...
					<iframe width="1000" height="600" src="https://www.youtube.com/embed/a1vZKBa2zHI?si=gYdkxQoS28yz65Ke" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" className="max-[600px]:w-[300px] max-[600px]:h-[600px] rounded pb-[5rem]  "></iframe>
					</main>
				{showPopup[0] && (
					<div className="fixed inset-0 bg-black/50 dark:bg-black/90 flex justify-center items-center z-20 popupb">
						<div className="bg-[#000000] w-[80vw] h-[90vh] p-8 rounded-lg flex flex-col overflow-y-scroll popupb" ref={popUpRef}>
							...
							<div className="flex-grow flex justify-between gap-4">
								...
								<div className="w-1/4">	
									<video src="/dbdbdb.mp4" className="w-full" autoPlay muted loop/>
								</div>
							</div>
						</div>
					</div>
				...
				>
					...
					<div className="max-[600px]:flex-col card-container-update flex flex-row gap-4">
...
<p className="font-normal text-gray-700 dark:text-gray-400">Participants to kindly note that the results for the prelim are now out. Congratulations to everyone who have proceded to the final round and thank to everyone for taking part.</p>
				...
				<main className="max-[600px]:hidden h-[40vh] bg-[#00070b] " id="contact">
